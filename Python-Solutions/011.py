...
# gets the diagonal to the right
def get_diagonal_right(x, y, grid):
	# i, j = starting coordinates
	numbers = []
	for i in range(4):
			numbers.append(grid[x+i][y+i])
		return numbers

# gets the diagonal to the left
def get_diagonal_left(x, y, grid):
	# i, j = starting coordinates
	numbers = []
	for i in range(4):
			numbers.append(grid[x-i][y-i])
...
# gets the horizontal
def get_horizontal(x, y, grid):
	# i, j = starting coordinates
	numbers = []
	for i in range(4):
			numbers.append(grid[x+i][y])
		return numbers

# gets the vertical
def get_vertical(x, y, grid):
	# i, j = starting coordinates
	numbers = []
	for i in range(4):
			numbers.append(grid[x][y+i])
		return numbers
